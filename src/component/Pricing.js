        ...
        <div className='w-full h-full flex justify-center'>
            <div className='w-[1300px] h-[500px] mt-24 flex justify-center'>
                ...
                <div className='w-80 h-full shadow-2xl rounded-lg ml-10 '>
                    <div className='w-full h-full flex items-center flex-col'>
                        <div className='w-full h-full bg-[#6327BC]'>
                            <div className='flex flex-col justify-center items-center mt-10 '>
                        ...
                        <div className='flex justify-center items-center flex-col mt-5'>
                            ...
                            <p className='text-slate-700'>Hotline support 24/7</p>
                            <button className='w-52 h-12 flex justify-center items-center mt-3 mb-3 bg-[#43B5EE] text-white text-base'>TRY THIS PACKAGE</button>
                        </div>
                    </div>
                </div>
                <div className='w-80 h-full shadow-2xl rounded-lg ml-10'>
